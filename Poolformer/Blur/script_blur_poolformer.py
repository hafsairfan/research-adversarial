...
# Create the dataset
dataset_b1 = datasets.ImageFolder(root="/home/my06200/Documents/Research_Adversarial_Dataset/corrupted_images",
                           transform=transforms.ToTensor())
# Create the dataloader
dataloader_b1 = DataLoader(dataset_b1, batch_size=batch_size, shuffle=True, num_workers=2)

dataset_b2= datasets.ImageFolder(root="/home/my06200/Documents/Research_Adversarial_Dataset/corrupted_images_blur2",
                           transform=transforms.ToTensor())
# Create the dataloader
...
test_ad_set_s1 = datasets.ImageFolder(root="/home/my06200/Documents/Research_Adversarial_Dataset/corrupted_images",
                           transform=test_ad_transforms_s1)
test_ad_set_s2= datasets.ImageFolder(root="/home/my06200/Documents/Research_Adversarial_Dataset/corrupted_images_blur2",
...
# Save the model
torch.save(model, "E2/poolformer_blur_E2.pth")
...
plt.ylabel('Loss')
plt.xticks(epochs)
plt.savefig('E2/Losses_Poolformer_E2_Blur.png')
plt.close()
# plt.show()
...
plt.ylabel('Accuracy')
plt.xticks(epochs)
plt.savefig('E2/Accuracies_Poolformer_E2_Blur.png')
plt.close()
# plt.show()