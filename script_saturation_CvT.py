...
# Create the dataset
dataset_b1 = datasets.ImageFolder(root="corrupted_images_saturate1",
                           transform=transforms.ToTensor())
# Create the dataloader
dataloader_b1 = DataLoader(dataset_b1, batch_size=batch_size, shuffle=True, num_workers=2)

dataset_b2= datasets.ImageFolder(root="corrupted_images_saturate2",
                           transform=transforms.ToTensor())
# Create the dataloader
...
test_ad_set_s1 = datasets.ImageFolder(root="corrupted_images_saturate1",
                           transform=test_ad_transforms_s1)
test_ad_set_s2= datasets.ImageFolder(root="corrupted_images_saturate2",
                           transform=test_ad_transforms_s2) 

print(train_set.classes)
print(train_set.class_to_idx)
print("Now test set for s1")
print(test_ad_set_s1.classes)
print(test_ad_set_s1.class_to_idx)
print("Now test set for s2")
print(test_ad_set_s2.classes)
print(test_ad_set_s2.class_to_idx)
...
plt.ylabel('Loss')
plt.xticks(epochs)
plt.savefig('Losses_CvT_Sat.png')
plt.close()
# plt.show()
...
plt.ylabel('Accuracy')
plt.xticks(epochs)
plt.savefig('Accuracies_CvT_Sat.png')
plt.close()
# plt.show()